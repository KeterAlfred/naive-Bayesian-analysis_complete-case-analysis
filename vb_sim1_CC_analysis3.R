...
time.1 <- system.time( #getDoParWorkers( )
  vb.sim1.CC.res51_75 <- foreach( m = 1:M, .inorder = FALSE, 
...
saveRDS(vb.sim1.CC.res51_75, file = "/kyukon/data/gent/438/vsc43892/vb_sim_analysis/vb.sim1.CC.res51_75.RData")
...
print( vb.sim1.CC.res51_75, intervals = c(0.5, 0.025, 0.975))
