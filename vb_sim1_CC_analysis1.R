...
# setwd("C:\\Users\\Keter\\OneDrive - ITG\\EDCTP\\PhD\\lca\\Vukuzazi\\revised analysis\\vb_sim_analysis\\CC_NN")
...
time.1 <- system.time( #getDoParWorkers( )
  vb.sim1.CC.res1_25 <- foreach( m = 1:M, .inorder = FALSE, 
...
saveRDS(vb.sim1.CC.res1_25, file = "/kyukon/data/gent/438/vsc43892/vb_sim_analysis/vb.sim1.CC.res1_25.RData")
...
# print( vb.sim1.CC.res1_25, intervals = c(0.5, 0.025, 0.975))
